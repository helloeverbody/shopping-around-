 ...
 */
@WebServlet("/CustomerQuickBatchDelete")
public class CustomerQuickBatchDelete extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String condition = " and cust_id in" + cust_id; // 查询条件
		...
		if (customerService.customerDelByCondition(customer)) {
